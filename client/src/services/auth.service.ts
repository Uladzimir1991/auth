...
export const AuthService = {
    ...
    async updateUser(name: string, phone: string, email: string, password: string) {
        return axios.put('auth/user/update', {name, phone, email, password})
    },

    async removeUser(name: string, phone: string, email: string, password: string) {
        return axios.delete('auth/user/remove', {data: {name, phone, email, password}})
    }
}